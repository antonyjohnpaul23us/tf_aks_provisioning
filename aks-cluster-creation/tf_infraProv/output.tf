...
# kube_config cna be taken using 'terraform output -raw kube_config > bb_sample_config' post apply
output "kube_config" {
  value       = "${module.kubernetes-cluster.kube_config}"
...
output "kubernetes_cluster_name" {
  value = "${module.kubernetes-cluster.kubernetes_cluster_name}"
}

output "kubernetes_cluster_resource_group_name" {
  value = "${module.kubernetes-cluster.kubernetes_cluster_resource_group_name}"
}